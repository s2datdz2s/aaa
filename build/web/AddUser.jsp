                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="signin-container">
                                ...
                                <form action="ManagerAdmin" name="frm-login" method="post">
                                    
                                    <p class="form-row">
                                        <label for="fid-name">ID created<span class="requite">*</span></label>
                                    ...
                                    <p class="form-row wrap-btn">
                                        <button class="btn btn-submit"  id="btnRegister" type="submit">Add user</button>
                                    </p>
                                </form>
                            </div>
                        </div>
