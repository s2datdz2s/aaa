<%-- 
    Document   : ChangePass
    Created on : Jan 7, 2024, 4:27:21 PM
    Author     : 
--%>
...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Biolife - Organic Perfume</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <form method="post" action="ChangePass">
                                <div  class="col-md-12">
                                    <label class="" >Email:</label><input class="form-control" readonly="" type="text" name="email" value=${param.email}>
                                    <input class="form-control" readonly="" type="hidden" name="key" value=${param.key}>
                                </div>
                                <div  class="col-md-12">
                                ...
                                <div  class="col-md-12">
                                    <input class="btn btn-primary"  type="submit" id="btnRegister" value="Edit" >
                                </div>
                            </form>
                        </div>
                    </div>
