<%-- 
    ...
    Created on : Jan 8, 2024, 8:05:56 AM
    Author     : 
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="row" >
                    ...
                    <div class="col-md-12">
                        ...
                        <div>    
                            Total Account:<input type="text" style="width: 50px"  value="${total}" name="total" class="" readonly> 
                        </div>

                        <form action="AddAdmin.jsp">
                            <div class="modal-header">
                                <button class="btn btn-submit "  id="btnLogin" type="submit" name="add">Add New Admin:</button>
                            </div>   
                        </form>

                        <form method="get" action="ManagerAdmin" style="width: 90%; padding: 15px; display: flex; justify-content: space-between">
                            <div>
                                <label >Gender:</label>
                                <div>
                                    <select name="uid">
                            ...
                            <tbody>
                                <c:forEach var="p" items="${ol}">
                                    <tr>
                                        ...
                                        <td>${p.getModifile_by()}</td>
                                        <td>${p.getModifile_on()}</td>
                                        <td>${p.getRoles().getId()==2?"Admin":"Seller"}</td>
                                        <td ><a href="DeleteAdmin?id=${p.getId()}" class="btn- btn-danger  btn-lg" style="display: block;" > Delete</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
